...
<body>
  ...
  <?php
   ...
   // while($row1 = mysql_fetch_array($result))
    ...
    $sql="Select * From Donor Where DonorID='$Did1';";
                          ...
                          <legend>Login Information</legend>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                ...
                                $DonorFullName; ?>" name="FullName" required/>
...
<!--  </form>-->
 ...
 <!-- </form>-->
    ...
    <center>
    <input type="submit" data-toggle="modal" name="sub" class="btn-primary btn-lg" value="update" />
