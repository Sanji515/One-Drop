...
<body>
    ...
    <div class="conatiner">
            ...
            <li class="active"><a data-toggle="tab" href="#BloodInfo" class="btn btn-success">Blood Info</a></li>
            <li><a data-toggle="tab" href="#Dlist" class="btn btn-success">Donor</a></li>
            <li><a data-toggle="tab" href="#Hlist" class="btn btn-success">List of Hospital</a></li>
...
<div class="tab-content">
	<div class="topdiv" style="height: 80px;"></div>
	<div id="BloodInfo" class="tab-pane fade in active">
						...
						if ($result->num_rows > 0) {
						    ...
						    ?>
						        <tr>
								                  ...
								                  <td><input type="submit" name="<?php echo htmlspecialchars($row['DonorID']); ?>" 
