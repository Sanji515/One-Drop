    ...
    <script>
      ...
      function checkPassword(){
            ...
            if(pwd != confirmpwd){
                ...
                $("#checkpwd").html("<div class="container">Password do not match!</div>");
            }
        }    
    </script>
...
<body>
    ...
    <!-- Login Information -->
    <form class="form-horizontal" action="demo.php" method="POST">
    <div class="container">
                          <legend>Login Information</legend>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">          
                                <input type="password" class="form-control" id="pwd" placeholder="Enter password" name="pwd" required maxlength="30">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="pwd">Confirm Password:</label>
                              <div class="col-sm-10">          
                                <input type="password" class="form-control" id="confirmpwd" placeholder="Confirm password" name="pwd" required maxlength="30" onchange="checkPassword()">
                              </div>
                            </div>
<!--  </form>-->
    </div>
   ...
   <!-- <form class="form-horizontal">-->
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        ...
        <div class="col-sm-10">
        <select class="form-control " id="HowOften">
