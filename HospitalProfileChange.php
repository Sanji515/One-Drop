...
<body>
   ...
   // while($row1 = mysql_fetch_array($result))
    ...
    Where HospitalID=H_ID and HospitalID='$Hid';";
   ...
   while ($row = $result->fetch_assoc()) 
   {
    ...
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="Hospital.php">Profile</a></li>
    ...
    <!-- Login Information --> 
    <form  class="form-horizontal autofocus" action="HospitalProfileChange1.php" method="POST">
    <div class="container">
  <legend>Login Information</legend>
   ...
   <!-- <div class="form-group">
    ...
    <br><br><br>
    <center>
    <input type="submit" data-toggle="modal" name="sub123" value="Update" class="btn-primary btn-lg">
        </center>
  </div>
</form>
